...
export type Type_201 = Type_201_V0 | Type_201_V1 | Type_201_V2

export interface Type_201_V0 {
    __kind: 'V0'
    value: Type_202
}

export interface Type_201_V1 {
    __kind: 'V1'
    value: Type_207
}

export interface Type_201_V2 {
    __kind: 'V2'
    value: Type_213[]
}
...
export type Call = Call_System | Call_ParachainSystem | Call_Timestamp | Call_Balances | Call_Authorship | Call_CollatorSelection | Call_Session | Call_XcmpQueue | Call_PolkadotXcm | Call_DmpQueue | Call_Sudo
...
export type Type_147 = Type_147_V1Ancient | Type_147_V2

export interface Type_147_V1Ancient {
    __kind: 'V1Ancient'
}

export interface Type_147_V2 {
    __kind: 'V2'
}
...
export type Type_202 = Type_202_WithdrawAsset | Type_202_ReserveAssetDeposit | Type_202_TeleportAsset | Type_202_QueryResponse | Type_202_TransferAsset | Type_202_TransferReserveAsset | Type_202_Transact | Type_202_HrmpNewChannelOpenRequest | Type_202_HrmpChannelAccepted | Type_202_HrmpChannelClosing | Type_202_RelayedFrom
...
export interface Type_202_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_204[]
}

export interface Type_202_TeleportAsset {
...
export type Type_207 = Type_207_WithdrawAsset | Type_207_ReserveAssetDeposited | Type_207_ReceiveTeleportedAsset | Type_207_QueryResponse | Type_207_TransferAsset | Type_207_TransferReserveAsset | Type_207_Transact | Type_207_HrmpNewChannelOpenRequest | Type_207_HrmpChannelAccepted | Type_207_HrmpChannelClosing | Type_207_RelayedFrom | Type_207_SubscribeVersion | Type_207_UnsubscribeVersion

export interface Type_207_WithdrawAsset {
    __kind: 'WithdrawAsset'
    assets: V1MultiAsset[]
    effects: Type_209[]
}

export interface Type_207_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    assets: V1MultiAsset[]
    effects: Type_209[]
}

export interface Type_207_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    assets: V1MultiAsset[]
    effects: Type_209[]
}

export interface Type_207_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V1Response
}

export interface Type_207_TransferAsset {
    __kind: 'TransferAsset'
    assets: V1MultiAsset[]
    beneficiary: V1MultiLocation
}

export interface Type_207_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V1MultiAsset[]
...
export interface Type_207_Transact {
    __kind: 'Transact'
    originType: V0OriginKind
    requireWeightAtMost: bigint
    call: DoubleEncoded
...
export interface Type_207_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_207_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_207_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_207_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V1Junctions
    message: Type_207
}

export interface Type_207_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_207_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export type Type_213 = Type_213_WithdrawAsset | Type_213_ReserveAssetDeposited | Type_213_ReceiveTeleportedAsset | Type_213_QueryResponse | Type_213_TransferAsset | Type_213_TransferReserveAsset | Type_213_Transact | Type_213_HrmpNewChannelOpenRequest | Type_213_HrmpChannelAccepted | Type_213_HrmpChannelClosing | Type_213_ClearOrigin | Type_213_DescendOrigin | Type_213_ReportError | Type_213_DepositAsset | Type_213_DepositReserveAsset | Type_213_ExchangeAsset | Type_213_InitiateReserveWithdraw | Type_213_InitiateTeleport | Type_213_QueryHolding | Type_213_BuyExecution | Type_213_RefundSurplus | Type_213_SetErrorHandler | Type_213_SetAppendix | Type_213_ClearError | Type_213_ClaimAsset | Type_213_Trap | Type_213_SubscribeVersion | Type_213_UnsubscribeVersion
...
export type Event = Event_System | Event_ParachainSystem | Event_Balances | Event_CollatorSelection | Event_Session | Event_XcmpQueue | Event_PolkadotXcm | Event_CumulusXcm | Event_DmpQueue | Event_Sudo
...
export type Type_204 = Type_204_Null | Type_204_DepositAsset | Type_204_DepositReserveAsset | Type_204_ExchangeAsset | Type_204_InitiateReserveWithdraw | Type_204_InitiateTeleport | Type_204_QueryHolding | Type_204_BuyExecution

export interface Type_204_Null {
    __kind: 'Null'
}
...
export type Type_209 = Type_209_Noop | Type_209_DepositAsset | Type_209_DepositReserveAsset | Type_209_ExchangeAsset | Type_209_InitiateReserveWithdraw | Type_209_InitiateTeleport | Type_209_QueryHolding | Type_209_BuyExecution
...
export type Type_79 = Type_79_Ok | Type_79_Err

export interface Type_79_Ok {
    __kind: 'Ok'
}

export interface Type_79_Err {
    __kind: 'Err'
    value: DispatchError
}
