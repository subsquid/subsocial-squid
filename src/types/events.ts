...
export class ProfilesProfileUpdatedEvent {
  constructor(private ctx: EventContext) {
    assert(this.ctx.event.name === 'profiles.ProfileUpdated')
  }

  get isV1(): boolean {
    return this.ctx._chain.getEventHash('profiles.ProfileUpdated') === '21ea0c8f2488eafafdea1de92b54cd17d8b1caff525e37616abf0ff93f11531d'
  }
