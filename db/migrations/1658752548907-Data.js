module.exports = class Data1658752548907 {
  name = 'Data1658752548907'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "space" ("id" character varying NOT NULL, "created_at_block" numeric, "created_at_time" TIMESTAMP WITH TIME ZONE, "created_on_day" TIMESTAMP WITH TIME ZONE, "updated_at_time" TIMESTAMP WITH TIME ZONE, "updated_at_block" numeric, "posts_count" integer NOT NULL, "public_posts_count" integer NOT NULL, "hidden_posts_count" integer NOT NULL, "content" text, "name" text, "image" text, "summary" text, "tags_original" text, "followers_count" integer NOT NULL, "created_by_account_id" character varying NOT NULL, "owner_account_id" character varying NOT NULL, CONSTRAINT "PK_094f5ec727fe052956a11623640" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "activity" ("id" character varying NOT NULL, "block_number" numeric NOT NULL, "event_index" integer NOT NULL, "event" character varying(19) NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "aggregated" boolean, "agg_count" numeric NOT NULL, "account_id" character varying NOT NULL, "following_account_id" character varying, "space_id" character varying, "space_prev_id" character varying, "post_id" character varying, "reaction_id" character varying, CONSTRAINT "PK_24625a1d6b1b089c8ae206fe467" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "account" ("id" character varying NOT NULL, "reputation" integer, "has_profile" boolean, "name" text, "avatar" text, "about" text, "created_at_block" numeric, "created_at_time" TIMESTAMP WITH TIME ZONE, "followers_count" integer NOT NULL, "following_accounts_count" integer NOT NULL, "following_posts_count" integer NOT NULL, "following_spaces_count" integer NOT NULL, CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_12dbd9880e109de2340cf75f8c" ON "account" ("has_profile") `)
  ...
  async down(db) {
    ...
    await db.query(`DROP INDEX "public"."IDX_12dbd9880e109de2340cf75f8c"`)
