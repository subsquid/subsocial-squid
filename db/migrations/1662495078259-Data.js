module.exports = class Data1662495078259 {
  name = 'Data1662495078259'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "space" ("id" character varying NOT NULL, "created_at_block" numeric, "created_at_time" TIMESTAMP WITH TIME ZONE, "created_on_day" TIMESTAMP WITH TIME ZONE, "updated_at_time" TIMESTAMP WITH TIME ZONE, "updated_at_block" numeric, "posts_count" integer NOT NULL, "public_posts_count" integer NOT NULL, "hidden_posts_count" integer NOT NULL, "content" text, "name" text, "image" text, "summary" text, "tags_original" text, "followers_count" integer NOT NULL, "created_by_account_id" character varying, "owner_account_id" character varying, CONSTRAINT "PK_094f5ec727fe052956a11623640" PRIMARY KEY ("id"))`)
