module.exports = class Data1671578118169 {
    name = 'Data1671578118169'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "post" ("id" character varying NOT NULL, "is_comment" boolean NOT NULL, "hidden" boolean NOT NULL, "created_at_block" numeric, "created_at_time" TIMESTAMP WITH TIME ZONE, "created_on_day" TIMESTAMP WITH TIME ZONE, "updated_at_time" TIMESTAMP WITH TIME ZONE, "kind" character varying(11), "followers_count" integer NOT NULL, "replies_count" integer NOT NULL, "public_replies_count" integer NOT NULL, "hidden_replies_count" integer NOT NULL, "shares_count" integer NOT NULL, "upvotes_count" integer NOT NULL, "downvotes_count" integer NOT NULL, "reactions_count" integer NOT NULL, "title" text, "image" text, "link" text, "canonical" text, "content" text, "slug" text, "body" text, "summary" text, "is_show_more" boolean, "meta" text, "tags_original" text, "format" text, "proposal_index" integer, "parent_post_id" character varying, "root_post_id" character varying, "shared_post_id" character varying, "owned_by_account_id" character varying, "created_by_account_id" character varying, "space_id" character varying, CONSTRAINT "PK_be5fda3aac270b134ff9c21cdee" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "activity" ("id" character varying NOT NULL, "block_number" numeric NOT NULL, "event_index" integer NOT NULL, "event" character varying(30) NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "aggregated" boolean, "agg_count" numeric NOT NULL, "account_id" character varying, "following_account_id" character varying, "space_id" character varying, "space_prev_id" character varying, "new_owner_id" character varying, "old_owner_id" character varying, "post_id" character varying, "reaction_id" character varying, CONSTRAINT "PK_24625a1d6b1b089c8ae206fe467" PRIMARY KEY ("id"))`)
