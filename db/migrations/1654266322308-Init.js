module.exports = class Init1654266322308 {
  name = 'Init1654266322308'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "space" ("id" character varying NOT NULL, "created_at_block" numeric, "created_at_time" TIMESTAMP WITH TIME ZONE, "created_on_day" TIMESTAMP WITH TIME ZONE, "space_id" text NOT NULL, "updated_at_time" TIMESTAMP WITH TIME ZONE, "posts_count" integer, "public_posts_count" integer, "hidden_posts_count" integer, "followers_count" integer, "score" integer, "content" text, "name" text, "image" text, "summary" text, "tags_original" text, "created_by_account_id" character varying NOT NULL, "owner_account_id" character varying NOT NULL, CONSTRAINT "PK_094f5ec727fe052956a11623640" PRIMARY KEY ("id"))`)
